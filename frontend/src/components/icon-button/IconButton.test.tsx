...
describe("IconButton", () => {
  ...
  it("should apply the active class when active prop is true", () => {
    render(() => (
      <IconButton icon={Square} aria-label="Active tool" active />
    ));
  ...
  it("should not apply the active class when active prop is omitted", () => {
    render(() => (
      <IconButton icon={Square} aria-label="Inactive tool" />
    ));
  ...
  it("should be disabled when disabled prop is set", () => {
    render(() => (
      <IconButton icon={Square} aria-label="Disabled tool" disabled />
    ));
  ...
  it("should render as a button element for keyboard accessibility", () => {
    render(() => (
      <IconButton icon={Square} aria-label="Keyboard test" />
    ));
