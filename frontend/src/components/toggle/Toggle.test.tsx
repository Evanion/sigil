...
describe("Toggle", () => {
  ...
  it("should render an element with switch role", () => {
    render(() => <Toggle checked={false} onCheckedChange={() => {}} aria-label="Test" />);
  ...
  it("should reflect checked state as aria-checked on the switch", () => {
    render(() => <Toggle checked={true} onCheckedChange={() => {}} aria-label="Test" />);
  ...
  it("should fire onCheckedChange when clicked", async () => {
    const handler = vi.fn();
    render(() => <Toggle checked={false} onCheckedChange={handler} aria-label="Test" />);
  ...
  it("should set data-disabled attribute when disabled", () => {
    render(() => (
      <Toggle checked={false} onCheckedChange={() => {}} disabled={true} aria-label="Test" />
    ));
    const root = screen.getByRole("switch").closest(".sigil-toggle");
    expect(root).toBeTruthy();
  ...
  it("should not fire onCheckedChange when disabled and clicked", async () => {
    const handler = vi.fn();
    render(() => (
      <Toggle checked={false} onCheckedChange={handler} disabled={true} aria-label="Test" />
    ));
    await fireEvent.click(screen.getByRole("switch"));
  ...
  it("should append custom class names alongside component classes", () => {
    render(() => (
      <Toggle checked={false} onCheckedChange={() => {}} class="my-custom" aria-label="Test" />
    ));
    const root = screen.getByRole("switch").closest(".sigil-toggle");
    expect(root).toBeTruthy();
  ...
  it("should forward aria-label to the switch element", () => {
    render(() => (
      <Toggle checked={false} onCheckedChange={() => {}} aria-label="Toggle visibility" />
    ));
